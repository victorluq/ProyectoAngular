...
import { HabilidadesFrontService } from 'src/app/servicios/habilidades-front.service';

@Component({
  selector: 'app-habiliagregar',
  templateUrl: './habiliagregar.component.html',
  styleUrls: ['./habiliagregar.component.css']
})
export class HabiliagregarComponent implements OnInit {
  ...
  constructor(private formBuilder: FormBuilder,
              private hfrontServ: HabilidadesFrontService) { 
  ...
  onCreate(): void {
    this.hfrontServ.agregarHabilidadesFront(this.form.value).subscribe(
    data => {
    }, () => {
